...
<body>
	...
	<div class="public_mbx">
		<ul>
			<span>当前位置：</span>
			<li><a href="/">首页</a></li>
			<li><a href="javascript:">红包发放</a></li>
		</ul>
	</div>
	<!-- news end -->
		...
		<div class="am-u-sm-7">
			<form class="public_form_info am-form" id="pub_hb_form" method="post">
				...
				<div class="am-form-group">
       			...
       			<div class="am-form-group">
					<label>红包发放<b>*</b></label>
					<input type="num" class="public_form_input w300" id="grant" placeholder="请输入要发放的红包金额" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" maxlength="6"/>
       			</div>
					<input type="button" id="pub_news" class="public_form_btn tk-magin-auto tk-margin-left-200" value="发放" onClick="consume_hongbao();">
			</form>
		</div>
	</div>
</body>
