...
//  表头  
    public static final String[] tableHeader = {"企业名称","姓名","用户名","金额","描述"};   				

//  创建工作本  
    public static HSSFWorkbook demoWorkBook = new HSSFWorkbook();   
//  创建表  
    public static HSSFSheet demoSheet = demoWorkBook.createSheet("我要融资");   
//  表头的单元格个数目  
    public static final short cellNumber = (short)tableHeader.length;   
//  数据库表的列数  
    public static final int columNumber = 5;  
...
public static void main(String[] args) {   
    String fileName = "D:\\我要融资"+System.currentTimeMillis()+".xls";   
